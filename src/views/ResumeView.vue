	...
	<section class="timeline-section">
		<div class="timeline-items">
			...
			<div class="timeline-item">
				...
				<div class="timeline-content">
					<h3>EXPERIENCE:</h3>
					<h4 class="text-white">{{ resume[2].retail }} <br>{{ resume[2].when }} <br> {{ resume[2].fb }} <br> {{
						resume[2].date }} <br> {{ resume[2].engineering }} <br> {{ resume[2].timeSpent }} <br> {{
		resume[2].developer }} <br> {{ resume[2].timeFrame }} </h4>
				</div>
			</div>
			<div class="timeline-item">
